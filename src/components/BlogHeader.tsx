    ...
    <div className="flex">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-wrap">
          <li className="before:list-none before:m-0 list-none font-normal text-[0.85rem] md:mr-4 sm:mr-0">
            {author.url}
          </li>
          <li className="before:list-none list-none font-normal text-[0.85rem]">
