...
import { discussionGraphQL, discussionDetailGraphQL } from '../graphQL/githubGraphQL';

const API_URL = 'https://api.github.com/graphql'
const GH_ACCESS_TOKEN = process.env.GH_ACCESS_TOKEN
const DISCUSSION_CATEGORY_ID = process.env.DISCUSSION_CATEGORY_ID //DIC_kwDOJakbGc4CWAdc
